export const TESTIMONIALS = [
    ...
    {
        content: "The AI Voice agents are incredible! They handle all my property inquiries 24/7, schedule viewings automatically, and never miss a lead. My response time improved dramatically.",
        author: "Michael",
