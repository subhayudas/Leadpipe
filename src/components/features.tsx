        ...
        <Wrapper className="py-20 lg:py-32">
            <div className="flex flex-col items-center text-center gap-4 mb-16">
                ...
                <AnimationContainer animation="fadeUp" delay={0.4}>
                    <p className="text-sm md:text-base lg:text-lg text-muted-foreground max-w-2xl mx-auto">
                        Experience the future of real estate with our all-in-one platform for seamless property management, powered by AI Voice agents.
                    </p>
                </AnimationContainer>
            </div>
            ...
            <div className="flex flex-col gap-6 px-1 md:px-0">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-1 gap-6">
                    <AnimationContainer animation="fadeUp" delay={0.9}>
                        <div className="relative rounded-3xl bg-[#191919] backdrop-blur-3xl overflow-hidden min-h-[350px]">
                            <div className="absolute inset-0 p-8 flex flex-col lg:flex-row justify-between items-center gap-8">
                                ...
                                <AnimationContainer animation="fadeLeft" delay={1.1}>
                                    <div className="relative h-48 w-full lg:w-96">
                                        <Image
